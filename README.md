...
### Sobre o Projeto
<p>Olá seja bem vindo ou bem vinda ao repositório do Spark.</r>  
...
Pagina de músicas para reprodução, busca e algumas funcionalidades como salvar as músicas favoritas.
...
```
git clone git@github.com:Adson-Gomes-Oliveira/Spark.git
```
